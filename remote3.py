...
def send_data_to_arduino(data, server_ip, server_port):
    global sock

    try:
        if sock is None:
            # Create a socket and connect only if it's not already initialized
    ...
    try:
        ...
        for i, detection_list in enumerate(detection_lists):
            ...
            for (x, y, w, h), score in detection_list:
                ...
                # Define the conditions for the direction based on distance and position
                if distance < 500:
                    direction = "Back"
                ...
                send_data_to_arduino(direction, server_ip, server_port)
